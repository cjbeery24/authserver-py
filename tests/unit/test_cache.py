...
class TestRBACCache:
    ...
    async def test_set_and_get_user_roles(self, clean_redis):
    ...
    async def test_get_user_roles_not_cached(self, clean_redis):
        """Test getting user roles when not cached."""
        cached_roles = await RBACCache.get_user_roles(999)
        assert cached_roles is None
    
    async def test_set_and_get_user_permissions(self, clean_redis):
    ...
    async def test_set_and_get_permission_check(self, clean_redis):
    ...
    async def test_set_and_get_role_permissions(self, clean_redis):
    ...
    async def test_invalidate_user(self, clean_redis):
    ...
    async def test_invalidate_role(self, clean_redis):
...
class TestUserDataCache:
    ...
    async def test_set_and_get_user_profile(self, clean_redis):
    ...
    async def test_get_user_profile_not_cached(self, clean_redis):
    ...
    async def test_invalidate_user_profile(self, clean_redis):
